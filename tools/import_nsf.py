...
class RPT4File:
    def __init__(self):
        ...
        # Default instrument bank is intentionally neutral; the translator applies the
        # Pac-Man CE voice map at conversion time to keep the final stream consistent.
        self.user_bank[80] = OPLPatch(m_ave=0x21, m_ksl=0x14, m_atdec=0xF0, m_susrel=0x12, m_wave=0x01,
                                     c_ave=0x21, c_ksl=0x00, c_atdec=0xF1, c_susrel=0x15, c_wave=0x01, feedback=0x02)
        self.user_bank[81] = OPLPatch(m_ave=0x21, m_ksl=0x12, m_atdec=0xF0, m_susrel=0x14, m_wave=0x01,
                                     c_ave=0x21, c_ksl=0x00, c_atdec=0xF2, c_susrel=0x17, c_wave=0x01, feedback=0x02)
        self.user_bank[33] = OPLPatch(m_ave=0x01, m_ksl=0x18, m_atdec=0xD0, m_susrel=0xF0, m_wave=0x00,
                                     c_ave=0x21, c_ksl=0x80, c_atdec=0xC0, c_susrel=0x84, c_wave=0x00, feedback=0x02)
        ...
        self.user_bank[38] = OPLPatch(m_ave=0x21, m_ksl=0x00, m_atdec=0xE8, m_susrel=0x30, m_wave=0x01,
                                     c_ave=0x21, c_ksl=0x00, c_atdec=0xE8, c_susrel=0x30, c_wave=0x00, feedback=0x01)
        self.user_bank[39] = OPLPatch(m_ave=0x01, m_ksl=0x18, m_atdec=0xD0, m_susrel=0xF0, m_wave=0x00,
                                     c_ave=0x21, c_ksl=0x80, c_atdec=0xC0, c_susrel=0x90, c_wave=0x00, feedback=0x00)
